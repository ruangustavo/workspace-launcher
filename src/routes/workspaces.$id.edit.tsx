...
export const Route = createFileRoute("/workspaces/$id/edit")({
		...
		return (
			<div className="max-w-2xl mx-auto space-y-6">
				...
				<Alert>
					...
					<AlertDescription>
						Workspace not found. It may have been deleted or the ID is
						incorrect.
					</AlertDescription>
				</Alert>
			</div>
	...
	const renderAppsStep = () => (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Modify applications that will be launched together
				</CardDescription>
			</CardHeader>
			<CardContent className="space-y-4">
				<Alert>
					<InfoIcon className="h-4 w-4" />
					<AlertDescription>
						Changes will only affect future launches of this workspace.
					</AlertDescription>
				</Alert>
	...
	const renderReviewStep = () => (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Review your workspace changes and save
				</CardDescription>
			</CardHeader>
			<CardContent className="space-y-4">
				<div className="space-y-2">
